...
public class JeopardyGameService
{
    ...
    private static List<JeopardyQuestion> GetAllQuestionPool()
    {
        ...
        [
            ...
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 100, Question = "Which Azure service is best for real-time analytics on streaming data?", Answer = "What is Azure Stream Analytics?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 100, Question = "What is the process of cleaning and combining data from multiple sources called?", Answer = "What is Data Integration?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 100, Question = "What is the process of transforming raw data into meaningful insights called?", Answer = "What is Data Analytics?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 100, Question = "Which Azure service provides a fully managed Apache Spark analytics platform?", Answer = "What is Azure Synapse Analytics?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 100, Question = "What is the main benefit of using PolyBase in Azure SQL Data Warehouse?", Answer = "What is querying external data directly?" },

            new() { Category = "DP-3020 (Advanced Data)", PointValue = 200, Question = "What is the process of distributing database data across multiple servers called?", Answer = "What is Sharding?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 200, Question = "What is the process of storing frequently accessed data for faster retrieval called?", Answer = "What is Caching?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 200, Question = "Which consistency model provides the highest availability but eventual consistency?", Answer = "What is BASE?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 200, Question = "What is the process of ensuring data is accurate and consistent over its lifecycle?", Answer = "What is Data Governance?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 200, Question = "Which Azure service is used for orchestrating data movement and transformation?", Answer = "What is Azure Data Factory?" },

            new() { Category = "DP-3020 (Advanced Data)", PointValue = 300, Question = "Which Azure service provides a fully managed Apache Spark analytics platform?", Answer = "What is Azure Synapse Analytics?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 300, Question = "What is the process of storing data in a way that reduces redundancy called?", Answer = "What is Normalization?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 300, Question = "What is the process of duplicating data across regions for disaster recovery called?", Answer = "What is Geo-Redundancy?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 300, Question = "Which Azure service provides a scalable NoSQL database?", Answer = "What is Azure Cosmos DB?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 300, Question = "What is the process of analyzing data to find patterns and relationships called?", Answer = "What is Data Mining?" },

            new() { Category = "DP-3020 (Advanced Data)", PointValue = 400, Question = "What is the main benefit of using PolyBase in Azure SQL Data Warehouse?", Answer = "What is querying external data directly?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 400, Question = "What is the process of ensuring data privacy and protection called?", Answer = "What is Data Security?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 400, Question = "Which Azure service provides a managed relational SQL database?", Answer = "What is Azure SQL Database?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 400, Question = "What is the process of transforming data into a format suitable for analysis called?", Answer = "What is Data Transformation?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 400, Question = "What is the process of storing data in a way that supports fast queries called?", Answer = "What is Indexing?" },

            new() { Category = "DP-3020 (Advanced Data)", PointValue = 500, Question = "Which consistency model provides the highest availability but eventual consistency?", Answer = "What is BASE?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 500, Question = "What is the process of splitting data across multiple servers for scalability called?", Answer = "What is Sharding?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 500, Question = "Which Azure service provides a globally distributed, multi-model database?", Answer = "What is Azure Cosmos DB?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 500, Question = "What is the process of ensuring data is available and durable called?", Answer = "What is High Availability?" },
            new() { Category = "DP-3020 (Advanced Data)", PointValue = 500, Question = "Which Azure service is best for storing large amounts of unstructured data?", Answer = "What is Azure Blob Storage?" },

            // ==================== DP-080 (Data Fundamentals) ====================
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 100, Question = "What is the primary language used to query relational databases?", Answer = "What is SQL?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 100, Question = "What type of database stores data in tables with rows and columns?", Answer = "What is a Relational Database?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 100, Question = "Which SQL command is used to retrieve data from a table?", Answer = "What is SELECT?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 100, Question = "What is the purpose of a primary key in a database table?", Answer = "What is to uniquely identify each record?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 100, Question = "What is the process of organizing data to reduce redundancy called?", Answer = "What is Normalization?" },

            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 200, Question = "Which SQL command is used to remove records from a table?", Answer = "What is DELETE?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 200, Question = "What is the process of adding new records to a table called?", Answer = "What is INSERT?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 200, Question = "What is the process of modifying existing records in a table called?", Answer = "What is UPDATE?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 200, Question = "What is the process of removing duplicate data called?", Answer = "What is Deduplication?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 200, Question = "What is the process of linking records between two tables called?", Answer = "What is a Foreign Key?" },

            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 300, Question = "What is the process of combining rows from two or more tables based on a related column called?", Answer = "What is JOIN?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 300, Question = "What is the process of grouping rows that have the same values called?", Answer = "What is GROUP BY?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 300, Question = "What is the process of sorting the results of a query called?", Answer = "What is ORDER BY?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 300, Question = "What is the process of filtering records based on a condition called?", Answer = "What is WHERE?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 300, Question = "What is the process of storing data in a way that supports fast queries called?", Answer = "What is Indexing?" },

            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 400, Question = "What is the process of ensuring data is accurate and consistent over its lifecycle called?", Answer = "What is Data Governance?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 400, Question = "What is the process of duplicating data across regions for disaster recovery called?", Answer = "What is Geo-Redundancy?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 400, Question = "What is the process of storing data in a way that reduces redundancy called?", Answer = "What is Normalization?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 400, Question = "What is the process of transforming data into a format suitable for analysis called?", Answer = "What is Data Transformation?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 400, Question = "What is the process of storing data in a way that supports fast queries called?", Answer = "What is Indexing?" },

            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 500, Question = "What is the process of splitting data across multiple servers for scalability called?", Answer = "What is Sharding?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 500, Question = "What is the process of ensuring data is available and durable called?", Answer = "What is High Availability?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 500, Question = "What is the process of storing data in a way that supports fast queries called?", Answer = "What is Indexing?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 500, Question = "What is the process of ensuring data privacy and protection called?", Answer = "What is Data Security?" },
            new() { Category = "DP-080 (Data Fundamentals)", PointValue = 500, Question = "What is the process of analyzing data to find patterns and relationships called?", Answer = "What is Data Mining?" },

            // ==================== DP-3001 (Azure Data) ====================
            new() { Category = "DP-3001 (Azure Data)", PointValue = 100, Question = "Which Azure service is a globally distributed, multi-model database?", Answer = "What is Azure Cosmos DB?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 100, Question = "Which Azure service provides managed relational SQL databases?", Answer = "What is Azure SQL Database?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 100, Question = "Which Azure service is best for storing large amounts of unstructured data?", Answer = "What is Azure Blob Storage?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 100, Question = "Which Azure service is used for orchestrating data movement and transformation?", Answer = "What is Azure Data Factory?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 100, Question = "Which Azure service provides a scalable NoSQL database?", Answer = "What is Azure Table Storage?" },

            new() { Category = "DP-3001 (Azure Data)", PointValue = 200, Question = "What is the main benefit of geo-replication in Azure SQL Database?", Answer = "What is disaster recovery and high availability?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 200, Question = "Which Azure service provides a fully managed Apache Spark analytics platform?", Answer = "What is Azure Synapse Analytics?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 200, Question = "Which Azure service provides a globally distributed, multi-model database?", Answer = "What is Azure Cosmos DB?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 200, Question = "Which Azure service provides a managed relational SQL database?", Answer = "What is Azure SQL Database?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 200, Question = "Which Azure service is best for storing large amounts of unstructured data?", Answer = "What is Azure Blob Storage?" },

            new() { Category = "DP-3001 (Azure Data)", PointValue = 300, Question = "Which Azure service provides managed relational SQL databases?", Answer = "What is Azure SQL Database?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 300, Question = "Which Azure service is used for orchestrating data movement and transformation?", Answer = "What is Azure Data Factory?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 300, Question = "Which Azure service provides a scalable NoSQL database?", Answer = "What is Azure Table Storage?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 300, Question = "Which Azure service provides a fully managed Apache Spark analytics platform?", Answer = "What is Azure Synapse Analytics?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 300, Question = "Which Azure service provides a globally distributed, multi-model database?", Answer = "What is Azure Cosmos DB?" },

            new() { Category = "DP-3001 (Azure Data)", PointValue = 400, Question = "What is the purpose of Azure Data Factory?", Answer = "What is to orchestrate and automate data movement and transformation?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 400, Question = "Which Azure service provides a managed relational SQL database?", Answer = "What is Azure SQL Database?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 400, Question = "Which Azure service provides a scalable NoSQL database?", Answer = "What is Azure Table Storage?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 400, Question = "Which Azure service provides a fully managed Apache Spark analytics platform?", Answer = "What is Azure Synapse Analytics?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 400, Question = "Which Azure service provides a globally distributed, multi-model database?", Answer = "What is Azure Cosmos DB?" },

            new() { Category = "DP-3001 (Azure Data)", PointValue = 500, Question = "Which Azure service is best for storing large amounts of unstructured data?", Answer = "What is Azure Blob Storage?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 500, Question = "Which Azure service provides a managed relational SQL database?", Answer = "What is Azure SQL Database?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 500, Question = "Which Azure service provides a scalable NoSQL database?", Answer = "What is Azure Table Storage?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 500, Question = "Which Azure service provides a fully managed Apache Spark analytics platform?", Answer = "What is Azure Synapse Analytics?" },
            new() { Category = "DP-3001 (Azure Data)", PointValue = 500, Question = "Which Azure service provides a globally distributed, multi-model database?", Answer = "What is Azure Cosmos DB?" },

            // ==================== AZ-900 (Azure Fundamentals) ====================
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 100, Question = "What is the main purpose of Azure Resource Groups?", Answer = "To organize and manage related Azure resources." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 100, Question = "What is the Azure Portal?", Answer = "A web-based interface for managing Azure resources." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 100, Question = "What is an Azure Subscription?", Answer = "A logical container used to provision resources in Azure." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 100, Question = "What is the basic unit of deployment in Azure?", Answer = "A Resource Group." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 100, Question = "What is Azure's command-line tool for managing resources?", Answer = "Azure CLI." },

            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 200, Question = "What is Azure Virtual Machine?", Answer = "A scalable computing resource in Azure." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 200, Question = "What is Azure Blob Storage used for?", Answer = "Storing massive amounts of unstructured data." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 200, Question = "What is Azure App Service?", Answer = "A platform for hosting web applications." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 200, Question = "What is Azure Function?", Answer = "A serverless compute service for running code on-demand." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 200, Question = "What is Azure SQL Database?", Answer = "A fully managed relational database service." },

            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 300, Question = "What is Azure Active Directory?", Answer = "A cloud-based identity and access management service." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 300, Question = "What is Azure Marketplace?", Answer = "An online store for Azure applications and services." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 300, Question = "What is Azure Advisor?", Answer = "A service that provides recommendations for Azure resources." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 300, Question = "What is Azure Policy?", Answer = "A service for creating, assigning, and managing policies in Azure." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 300, Question = "What is Azure Monitor?", Answer = "A service for monitoring the health and performance of Azure resources." },

            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 400, Question = "What is Azure CDN?", Answer = "A content delivery network for fast global content delivery." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 400, Question = "What is Azure DNS?", Answer = "A service for hosting DNS domains and managing DNS records." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 400, Question = "What is Azure ExpressRoute?", Answer = "A service for creating private connections between Azure datacenters and infrastructure on-premises." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 400, Question = "What is Azure Load Balancer?", Answer = "A service for distributing incoming network traffic across multiple resources." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 400, Question = "What is Azure Security Center?", Answer = "A unified infrastructure security management system." },

            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 500, Question = "What is Azure Cost Management?", Answer = "A service for monitoring and controlling Azure spending." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 500, Question = "What is Azure Blueprints?", Answer = "A service for defining repeatable Azure resource deployments." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 500, Question = "What is Azure Resource Manager (ARM)?", Answer = "A management layer for deploying and managing Azure resources." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 500, Question = "What is Azure Service Health?", Answer = "A service that provides personalized alerts and guidance when Azure service issues affect you." },
            new() { Category = "AZ-900 (Azure Fundamentals)", PointValue = 500, Question = "What is Azure Management Group?", Answer = "A level of scope above subscriptions for managing access, policy, and compliance." },

            // ==================== AZ-204 (Azure Developer) ====================
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 100, Question = "What is Azure App Service used for?", Answer = "Hosting web apps, RESTful APIs, and mobile back ends." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 100, Question = "What is Azure Functions?", Answer = "A serverless compute service for running event-driven code." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 100, Question = "What is Azure Logic Apps?", Answer = "A service for automating workflows and integrating apps, data, and services." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 100, Question = "What is Azure Blob Storage?", Answer = "A service for storing large amounts of unstructured data." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 100, Question = "What is Azure Key Vault?", Answer = "A service for securely storing and accessing secrets, keys, and certificates." },

            new() { Category = "AZ-204 (Azure Developer)", PointValue = 200, Question = "What is Azure Cosmos DB?", Answer = "A globally distributed, multi-model database service." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 200, Question = "What is Azure Event Grid?", Answer = "A service for managing events in a serverless architecture." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 200, Question = "What is Azure Service Bus?", Answer = "A fully managed enterprise message broker." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 200, Question = "What is Azure Table Storage?", Answer = "A NoSQL key-value store for rapid development using massive semi-structured datasets." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 200, Question = "What is Azure SQL Database?", Answer = "A fully managed relational database service." },

            new() { Category = "AZ-204 (Azure Developer)", PointValue = 300, Question = "What is Azure API Management?", Answer = "A service for publishing, securing, and analyzing APIs." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 300, Question = "What is Azure DevOps?", Answer = "A suite of development tools for software teams." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 300, Question = "What is Azure Kubernetes Service (AKS)?", Answer = "A managed Kubernetes container orchestration service." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 300, Question = "What is Azure Notification Hubs?", Answer = "A service for sending push notifications to any platform from any back end." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 300, Question = "What is Azure Redis Cache?", Answer = "A fully managed, in-memory cache that enables high-performance and scalable architectures." },

            new() { Category = "AZ-204 (Azure Developer)", PointValue = 400, Question = "What is Azure Virtual Network?", Answer = "A service for securely connecting Azure resources to each other." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 400, Question = "What is Azure Load Balancer?", Answer = "A service for distributing incoming network traffic across multiple resources." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 400, Question = "What is Azure Application Gateway?", Answer = "A web traffic load balancer that enables you to manage traffic to your web applications." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 400, Question = "What is Azure Traffic Manager?", Answer = "A DNS-based traffic load balancer." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 400, Question = "What is Azure CDN?", Answer = "A content delivery network for fast global content delivery." },

            new() { Category = "AZ-204 (Azure Developer)", PointValue = 500, Question = "What is Azure Resource Manager (ARM)?", Answer = "A management layer for deploying and managing Azure resources." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 500, Question = "What is Azure Policy?", Answer = "A service for creating, assigning, and managing policies in Azure." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 500, Question = "What is Azure Blueprints?", Answer = "A service for defining repeatable Azure resource deployments." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 500, Question = "What is Azure Monitor?", Answer = "A service for monitoring the health and performance of Azure resources." },
            new() { Category = "AZ-204 (Azure Developer)", PointValue = 500, Question = "What is Azure Security Center?", Answer = "A unified infrastructure security management system." },

            // ==================== AI-900 (Azure AI Fundamentals) ====================
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 100, Question = "What is Artificial Intelligence (AI)?", Answer = "The simulation of human intelligence by machines." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 100, Question = "What is Machine Learning (ML)?", Answer = "A subset of AI that enables systems to learn from data." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 100, Question = "What is Azure Cognitive Services?", Answer = "A suite of pre-built AI services for vision, speech, language, and decision-making." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 100, Question = "What is Natural Language Processing (NLP)?", Answer = "A field of AI focused on the interaction between computers and humans using natural language." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 100, Question = "What is Computer Vision?", Answer = "A field of AI that trains computers to interpret and understand the visual world." },

            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 200, Question = "What is Azure Machine Learning?", Answer = "A cloud-based platform for building, training, and deploying machine learning models." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 200, Question = "What is a chatbot?", Answer = "A software application used to conduct an online chat conversation via text or text-to-speech." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 200, Question = "What is supervised learning?", Answer = "A type of machine learning where the model is trained on labeled data." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 200, Question = "What is unsupervised learning?", Answer = "A type of machine learning where the model is trained on unlabeled data." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 200, Question = "What is reinforcement learning?", Answer = "A type of machine learning where an agent learns to behave in an environment by performing actions and receiving rewards." },

            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 300, Question = "What is a neural network?", Answer = "A series of algorithms that attempt to recognize underlying relationships in a set of data through a process that mimics the way the human brain operates." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 300, Question = "What is deep learning?", Answer = "A subset of machine learning that uses neural networks with many layers." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 300, Question = "What is computer vision used for?", Answer = "To enable computers to interpret and process visual information from the world." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 300, Question = "What is speech recognition?", Answer = "The ability of a machine or program to identify words and phrases in spoken language and convert them to machine-readable format." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 300, Question = "What is anomaly detection?", Answer = "The identification of rare items, events or observations which raise suspicions by differing significantly from the majority of the data." },

            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 400, Question = "What is Azure Bot Service?", Answer = "A managed service for developing intelligent, enterprise-grade bots." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 400, Question = "What is Azure AI Search?", Answer = "A cloud search service with built-in AI capabilities." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 400, Question = "What is responsible AI?", Answer = "The practice of designing, developing, and deploying AI with good intentions to empower employees and businesses, and fairly impact customers and society." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 400, Question = "What is a data label?", Answer = "A tag or identifier assigned to a piece of data to help machine learning models learn from it." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 400, Question = "What is model training?", Answer = "The process of teaching a machine learning model to make predictions or decisions." },

            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 500, Question = "What is transfer learning?", Answer = "A machine learning method where a model developed for a task is reused as the starting point for a model on a second task." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 500, Question = "What is a confusion matrix?", Answer = "A table used to describe the performance of a classification model." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 500, Question = "What is F1 Score?", Answer = "A measure of a test's accuracy that considers both the precision and the recall." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 500, Question = "What is data augmentation?", Answer = "A technique used to increase the amount of data by adding slightly modified copies of already existing data or newly created synthetic data from existing data." },
            new() { Category = "AI-900 (Azure AI Fundamentals)", PointValue = 500, Question = "What is a transformer model?", Answer = "A deep learning model that uses self-attention mechanisms, widely used in natural language processing." },

            // ==================== .NET Core ====================
            new() { Category = ".NET Core", PointValue = 100, Question = "What is .NET Core?", Answer = "A cross-platform, open-source framework for building modern applications." },
            new() { Category = ".NET Core", PointValue = 100, Question = "Which command creates a new .NET Core console app?", Answer = "dotnet new console" },
            new() { Category = ".NET Core", PointValue = 100, Question = "What is the default package manager for .NET Core?", Answer = "NuGet" },
            new() { Category = ".NET Core", PointValue = 100, Question = "Which file defines project dependencies in .NET Core?", Answer = ".csproj" },
            new() { Category = ".NET Core", PointValue = 100, Question = "Which command restores NuGet packages?", Answer = "dotnet restore" },
            new() { Category = ".NET Core", PointValue = 200, Question = "Which command builds a .NET Core project?", Answer = "dotnet build" },
            new() { Category = ".NET Core", PointValue = 200, Question = "Which command runs unit tests in .NET Core?", Answer = "dotnet test" },
            new() { Category = ".NET Core", PointValue = 200, Question = "What is the entry point method for a .NET Core app?", Answer = "Main()" },
            new() { Category = ".NET Core", PointValue = 200, Question = "What is the purpose of appsettings.json?", Answer = "To store configuration settings." },
            new() { Category = ".NET Core", PointValue = 200, Question = "Which command publishes a .NET Core app for deployment?", Answer = "dotnet publish" },
            new() { Category = ".NET Core", PointValue = 300, Question = "What is dependency injection in .NET Core?", Answer = "A technique for achieving loose coupling by injecting dependencies at runtime." },
            new() { Category = ".NET Core", PointValue = 300, Question = "What is middleware in ASP.NET Core?", Answer = "Software that handles requests and responses in the pipeline." },
            new() { Category = ".NET Core", PointValue = 300, Question = "What is Kestrel?", Answer = "A cross-platform web server for ASP.NET Core." },
            new() { Category = ".NET Core", PointValue = 300, Question = "What is Entity Framework Core?", Answer = "An ORM for .NET Core." },
            new() { Category = ".NET Core", PointValue = 300, Question = "What is the purpose of Startup.cs?", Answer = "To configure services and the app's request pipeline." },
            new() { Category = ".NET Core", PointValue = 400, Question = "What is a hosted service in .NET Core?", Answer = "A background task that runs with the app." },
            new() { Category = ".NET Core", PointValue = 400, Question = "What is the difference between IHostedService and BackgroundService?", Answer = "BackgroundService is a base class for implementing long-running IHostedService tasks." },
            new() { Category = ".NET Core", PointValue = 400, Question = "What is the use of IConfiguration?", Answer = "To access configuration settings in .NET Core." },
            new() { Category = ".NET Core", PointValue = 400, Question = "What is the use of IWebHostBuilder?", Answer = "To configure and create a web host in ASP.NET Core." },
            new() { Category = ".NET Core", PointValue = 400, Question = "What is the use of UseUrls() in ASP.NET Core?", Answer = "To specify the URLs the web host will listen on." },
            new() { Category = ".NET Core", PointValue = 500, Question = "What is the difference between .NET Core and .NET Framework?", Answer = ".NET Core is cross-platform and open-source; .NET Framework is Windows-only." },
            new() { Category = ".NET Core", PointValue = 500, Question = "What is the Generic Host in .NET Core?", Answer = "A host for non-web apps, supporting DI, logging, and configuration." },
            new() { Category = ".NET Core", PointValue = 500, Question = "What is the use of IOptions<T> in .NET Core?", Answer = "To access strongly typed configuration settings." },
            new() { Category = ".NET Core", PointValue = 500, Question = "What is the difference between AddSingleton, AddScoped, and AddTransient?", Answer = "They define service lifetimes for DI." },
            new() { Category = ".NET Core", PointValue = 500, Question = "What is the use of UseStartup<T>()?", Answer = "To specify the Startup class for the app." },
        ];
    }
}
